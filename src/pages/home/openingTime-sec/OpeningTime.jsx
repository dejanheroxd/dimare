    ...
    >
      ...
      <div>
        ...
        >
          <p className="pb-1">
            Δευτέρα - Παρασκευή
            <span className="text-gray-500"> : 11:00 - 23:00</span>
          </p>
          <p className="pb-1">
            Σάββατο<span className="text-gray-500"> : 11:00 - 23:00</span>
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 70 }}
        ...
        >
          <p className="pb-1">
            Κυριακή<span className="text-gray-500"> : 10:00 - 22:00</span>
          </p>
          <p className="pb-1">
